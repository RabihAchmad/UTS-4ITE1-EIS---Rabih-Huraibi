...
<div class="container">
    <div class="row">
        ...
        <div class="form-group">
         <textarea type="text" name="description" class="form-control" placeholder="what's up?"></textarea>
        </div>
            ...
            <div class="sidebar_right">
                <div class="sidebar_right_follow">
                    <div class="col-md-4" style="padding: 0;">
                            <img class="card-img-top" src="{{asset('image/spongebob.jpg')}}" alt="Card image cap">
                    </div>
                    <div class="col-md-8" style="padding-left: 0;">
                  <span style="margin-bottom: 0"><b>Tester </b></span><br>             
                <span>@tester</span>
            ...
            <div class="sidebar_right">
                <div class="sidebar_right_follow">
                  <div class="col-md-4" style="padding: 0;">
                    ...
                    <div class="col-md-8" style="padding-left: 0;">
                  <span style="margin-bottom: 0"><b>Asep </b></span><br>             
                <span>@masasep</span><br>
                <a href="#" class="btn btn-success btn-sm">follow</a>
                    </div>
            </div>
            </div>
